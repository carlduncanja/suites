...
const StorageEquipmentTab = ({equipments = []}) => {
    ...
    const listItem = item => (
        <>
            ...
            <DataItem align="center" color="--color-gray-600" fontStyle="--text-base-regular" text={item?.amount || 0}/>
            <DataItem align="flex-end" color="--color-gray-600" fontStyle="--text-base-regular" text={item.unitPrice || 0}/>
        </>
    );
    ...
    const handleHeaderCheckbox = () => {
        let updatedItemsList = selectAll(equipments, checkedItems);
    ...
    const floatingActions = () => {
        let isDisabled = checkedItems.length === 0;
