...
const PatientAddressTab = ({ onAddressInfoChange, fields, errors }) => {
  ...
  const { line1 = "", line2 = "", city = "", parish = "" } = addressInfo;
        ...
        <InputWrapper>
          <InputField2
            ...
            onChangeText={(value) => {
              ...
              if (isValid) onAddressInfoChange("line1")(value);
            }}
            value={line1}
      ...
      <RowWrapper theme={theme}>
        <InputWrapper>
          <InputField2
            ...
            onChangeText={(value) => {
              const isValid = validateAddressField(value);
              if (isValid) onAddressInfoChange("line2")(value);
            }}
            value={line2}
      ...
      <RowWrapper theme={theme}>
        <InputWrapper>
          <InputField2
            ...
            onChangeText={(value) => {
              const isValid = validateAddressField(value);
              if (isValid) onAddressInfoChange("city")(value);
            }}
            value={city}
      ...
      <RowWrapper theme={theme}>
        <InputWrapper>
          <InputField2
            ...
            onChangeText={(value) => {
              const isValid = validateAddressField(value);
              if (isValid) onAddressInfoChange("parish")(value);
            }}
            value={parish}
