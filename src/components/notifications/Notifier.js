...
import {addNotification, closeNotification, removeNotification} from "../../redux/actions/NotificationActions";
        ...
        return (
            ...
            <SafeAreaView pointerEvents={"box-none"} style={{...StyleSheet.absoluteFillObject}}>
                <View pointerEvents={"box-none"}
                    ...
                    {
                        this.props.notifications.map(({key, message, title, action, dismissed = false}, index) => {
                            ...
                            return (
                                <Animatable.View
                                    ...
                                    key={key}
                                    pointerEvents={"auto"}
                                    onAnimationEnd={(endState) => this._handleAnimationEnd(dismissed, key, endState)}
