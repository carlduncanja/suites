...
const PaginatorNumbersContainer = styled.View`
    ...
    align-items: center;
    background-color: ${({ theme, hasNumberBorder }) =>
        hasNumberBorder && theme.colors["--color-neutral-gray-100"]};
    border: ${({ theme, hasNumberBorder }) =>
        hasNumberBorder && `1px solid ${theme.colors["--color-gray-400"]}`};
    border-radius: ${({ theme, hasNumberBorder }) =>
        hasNumberBorder && theme.space["--space-4"]};
`;
