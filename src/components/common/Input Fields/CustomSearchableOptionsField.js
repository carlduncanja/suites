 ...
 * @constructor
 */
function CustomSearchableOptionsField({
                                    text,
                                    label,
                                    labelWidth,
                                    options,
...
CustomSearchableOptionsField.propTypes = {};
CustomSearchableOptionsField.defaultProps = {};
...
export default CustomSearchableOptionsField;
