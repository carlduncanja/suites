...
const RadioContainer = styled.View`
    background-color: ${({ checkedButton, name, theme }) =>
        checkedButton === name ? theme.colors["--color-blue-600"] : "white"};
...
const PrintDropdownContainer = styled.TouchableOpacity`
    ...
    /* top: 24px; */
    padding: ${({ theme }) =>
        `${theme.space["--space-14"]} ${theme.space["--space-12"]}`};
...
const PrintOptionContainer = styled.TouchableOpacity`
    ...
    background-color: ${({ theme, isSelected }) =>
        isSelected
            ? theme.colors["--color-blue-100"]
            : theme.colors["--color-white"]};
...
const PrintOption = styled.Text`
    ...
    color: ${({ theme, isSelected }) =>
        isSelected
            ? theme.colors["--color-blue-600"]
            : theme.colors["--color-gray-800"]};
    text-wrap: "nowrap";
`;
                ...
                {options.map((item, index) => (
                    <PopupContainer>
                        <RadioContainer
                            key={index}
                            theme={theme}
                            checkedButton={checkedRadioButton}
                            name={item.name}
                        >
                            <RadioButton
                                value={item.name}
                                status={
                                    checkedRadioButton === item.name
                                        ? "checked"
                                        : "unchecked"
                                }
            ...
            <PrintDropdownContainer theme={theme}>
                {printScheduleOptions.map((option, index) => (
                    <PrintOptionContainer
                        ...
                        style={{
                            marginBottom:
                                index === printScheduleOptions.length - 1
                                    ? 0
                                    : 8,
                        }}
                        activeOpacity={0.5}
                    ...
                    <GroupButtonContainer>
                        ...
                        >
                            <IconContainer
                                ...
                                onPress={() =>
                                    openPrintOptions(!showPrintOptions)
                                }
                            >
                                <PrintIcon
                                    strokeColor={
