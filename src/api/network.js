...
export const endProcedure = async (id, data) => suitesAxiosInstance
...
export const getCaseFileByPatientId = async id => suitesAxiosInstance
...
export const sendToSupplier = async (purchaseOrderId, email) => suitesAxiosInstance
...
export const getPatientbyId = async (id) => suitesAxiosInstance
