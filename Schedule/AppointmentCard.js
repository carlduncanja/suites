                ...
                <View style={styles.footerContainer}> 
                    ...
                    <View style={styles.footer}>
                       {this.props.scheduleButtons === true ? 
                            <View>
                                { actionButtons }
                                <TouchableOpacity onPress={this.props.showScheduleButtons} style={[styles.buttonController, {backgroundColor:'#A0AEC0'}]}>
                                    {buttonsController('white')}
                                </TouchableOpacity> 
                            </View>
                            : 
                            <TouchableOpacity onPress={this.props.showScheduleButtons} style={[styles.buttonController, {backgroundColor:'white'}]}>
