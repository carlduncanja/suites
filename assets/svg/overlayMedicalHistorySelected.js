...
const overlayMedicalHistorySelected = () => (
    <View>
...
overlayMedicalHistorySelected.propTypes = {};
overlayMedicalHistorySelected.defaultProps = {};

export default overlayMedicalHistorySelected