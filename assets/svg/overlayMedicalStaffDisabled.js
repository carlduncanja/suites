...
const overlayMedicalStaffDisabled = () => (
    <View>
...
overlayMedicalStaffDisabled.propTypes = {};
overlayMedicalStaffDisabled.defaultProps = {};

export default overlayMedicalStaffDisabled